...
export const home = () => {
  ...
  const generateFigureContent = ({ bride }) => {
    ...
    return `
            <div>
                <img class="flower flower-top" src="./src/assets/images/flower.webp" alt="couple animation">
                <img class="avatar" src="${coupleImage}" alt="couple animation">
                <figcaption>
                    ${brideLName.split(' ')[0]} & ${bridePName.split(' ')[0]}
                </figcaption>
                <img class="flower flower-bottom" src="./src/assets/images/flower.webp" alt="couple animation">
            </div>`;
  };
